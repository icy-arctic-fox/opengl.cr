module OpenGL
  module Procs
    ...
    @[AlwaysInline]
    def flush_mapped_named_buffer_range : ::Proc.class
      ::Proc(LibGL::UInt, LibGL::IntPtr, LibGL::SizeIPtr, ::Void)
    end
    ...
    @[AlwaysInline]
    def create_vertex_arrays : ::Proc.class
      ::Proc(LibGL::SizeI, ::Pointer(LibGL::UInt), ::Void)
    end

    # `Proc` type for the OpenGL function *glDisableVertexArrayAttrib*.
    @[AlwaysInline]
    def disable_vertex_array_attrib : ::Proc.class
      ::Proc(LibGL::UInt, LibGL::UInt, ::Void)
    end
    ...
    # `Proc` type for the OpenGL function *glGetnMapdv*.
    @[AlwaysInline]
    def getn_map_dv : ::Proc.class
      ::Proc(LibGL::MapTarget, LibGL::MapQuery, LibGL::SizeI, ::Pointer(LibGL::Double), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnMapfv*.
    @[AlwaysInline]
    def getn_map_fv : ::Proc.class
      ::Proc(LibGL::MapTarget, LibGL::MapQuery, LibGL::SizeI, ::Pointer(LibGL::Float), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnMapiv*.
    @[AlwaysInline]
    def getn_map_iv : ::Proc.class
      ::Proc(LibGL::MapTarget, LibGL::MapQuery, LibGL::SizeI, ::Pointer(LibGL::Int), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnPixelMapfv*.
    @[AlwaysInline]
    def getn_pixel_map_fv : ::Proc.class
      ::Proc(LibGL::PixelMap, LibGL::SizeI, ::Pointer(LibGL::Float), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnPixelMapuiv*.
    @[AlwaysInline]
    def getn_pixel_map_uiv : ::Proc.class
      ::Proc(LibGL::PixelMap, LibGL::SizeI, ::Pointer(LibGL::UInt), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnPixelMapusv*.
    @[AlwaysInline]
    def getn_pixel_map_usv : ::Proc.class
      ::Proc(LibGL::PixelMap, LibGL::SizeI, ::Pointer(LibGL::UShort), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnPolygonStipple*.
    @[AlwaysInline]
    def getn_polygon_stipple : ::Proc.class
      ::Proc(LibGL::SizeI, ::Pointer(LibGL::UByte), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnColorTable*.
    @[AlwaysInline]
    def getn_color_table : ::Proc.class
      ::Proc(LibGL::Enum, LibGL::PixelFormat, LibGL::PixelType, LibGL::SizeI, ::Pointer(Void), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnConvolutionFilter*.
    @[AlwaysInline]
    def getn_convolution_filter : ::Proc.class
      ::Proc(LibGL::Enum, LibGL::PixelFormat, LibGL::PixelType, LibGL::SizeI, ::Pointer(Void), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnSeparableFilter*.
    @[AlwaysInline]
    def getn_separable_filter : ::Proc.class
      ::Proc(LibGL::Enum, LibGL::PixelFormat, LibGL::PixelType, LibGL::SizeI, ::Pointer(Void), LibGL::SizeI, ::Pointer(Void), ::Pointer(Void), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnHistogram*.
    @[AlwaysInline]
    def getn_histogram : ::Proc.class
      ::Proc(LibGL::Enum, LibGL::Boolean, LibGL::PixelFormat, LibGL::PixelType, LibGL::SizeI, ::Pointer(Void), ::Void)
    end

    # `Proc` type for the OpenGL function *glGetnMinmax*.
    @[AlwaysInline]
    def getn_minmax : ::Proc.class
      ::Proc(LibGL::Enum, LibGL::Boolean, LibGL::PixelFormat, LibGL::PixelType, LibGL::SizeI, ::Pointer(Void), ::Void)
    end
