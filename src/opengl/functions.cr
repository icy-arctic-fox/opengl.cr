...
lib LibGL
  ...
  fun get_query_object_ui64v = glGetQueryObjectui64v(
    id : UInt,
    pname : QueryObjectParameterName,
  ...
  fun vertex_p2ui = glVertexP2ui(
    type : VertexPointerType,
    value : UInt
  ) : ::Void

  fun vertex_p2uiv = glVertexP2uiv(
    type : VertexPointerType,
    value : ::Pointer(UInt)
  ) : ::Void

  fun vertex_p3ui = glVertexP3ui(
    type : VertexPointerType,
    value : UInt
  ) : ::Void

  fun vertex_p3uiv = glVertexP3uiv(
    type : VertexPointerType,
    value : ::Pointer(UInt)
  ) : ::Void

  fun vertex_p4ui = glVertexP4ui(
    type : VertexPointerType,
    value : UInt
  ) : ::Void

  fun vertex_p4uiv = glVertexP4uiv(
    type : VertexPointerType,
    value : ::Pointer(UInt)
  ) : ::Void

  fun tex_coord_p1ui = glTexCoordP1ui(
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun tex_coord_p1uiv = glTexCoordP1uiv(
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun tex_coord_p2ui = glTexCoordP2ui(
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun tex_coord_p2uiv = glTexCoordP2uiv(
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun tex_coord_p3ui = glTexCoordP3ui(
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun tex_coord_p3uiv = glTexCoordP3uiv(
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun tex_coord_p4ui = glTexCoordP4ui(
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun tex_coord_p4uiv = glTexCoordP4uiv(
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun multi_tex_coord_p1ui = glMultiTexCoordP1ui(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun multi_tex_coord_p1uiv = glMultiTexCoordP1uiv(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun multi_tex_coord_p2ui = glMultiTexCoordP2ui(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun multi_tex_coord_p2uiv = glMultiTexCoordP2uiv(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun multi_tex_coord_p3ui = glMultiTexCoordP3ui(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun multi_tex_coord_p3uiv = glMultiTexCoordP3uiv(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun multi_tex_coord_p4ui = glMultiTexCoordP4ui(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : UInt
  ) : ::Void

  fun multi_tex_coord_p4uiv = glMultiTexCoordP4uiv(
    texture : TextureUnit,
    type : TexCoordPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun normal_p3ui = glNormalP3ui(
    type : NormalPointerType,
    coords : UInt
  ) : ::Void

  fun normal_p3uiv = glNormalP3uiv(
    type : NormalPointerType,
    coords : ::Pointer(UInt)
  ) : ::Void

  fun color_p3ui = glColorP3ui(
    type : ColorPointerType,
    color : UInt
  ) : ::Void

  fun color_p3uiv = glColorP3uiv(
    type : ColorPointerType,
    color : ::Pointer(UInt)
  ) : ::Void

  fun color_p4ui = glColorP4ui(
    type : ColorPointerType,
    color : UInt
  ) : ::Void

  fun color_p4uiv = glColorP4uiv(
    type : ColorPointerType,
    color : ::Pointer(UInt)
  ) : ::Void

  fun secondary_color_p3ui = glSecondaryColorP3ui(
    type : ColorPointerType,
    color : UInt
  ) : ::Void

  fun secondary_color_p3uiv = glSecondaryColorP3uiv(
    type : ColorPointerType,
    color : ::Pointer(UInt)
  ) : ::Void
  ...
  fun uniform_matrix2_dv = glUniformMatrix2dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix3_dv = glUniformMatrix3dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix4_dv = glUniformMatrix4dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix2x3_dv = glUniformMatrix2x3dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix2x4_dv = glUniformMatrix2x4dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix3x2_dv = glUniformMatrix3x2dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix3x4_dv = glUniformMatrix3x4dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix4x2_dv = glUniformMatrix4x2dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun uniform_matrix4x3_dv = glUniformMatrix4x3dv(
    location : Int,
    count : SizeI,
    transpose : Boolean,
    value : ::Pointer(Double)
  ...
  fun program_uniform_matrix2_fv = glProgramUniformMatrix2fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix3_fv = glProgramUniformMatrix3fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix4_fv = glProgramUniformMatrix4fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix2_dv = glProgramUniformMatrix2dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix3_dv = glProgramUniformMatrix3dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix4_dv = glProgramUniformMatrix4dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix2x3_fv = glProgramUniformMatrix2x3fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix3x2_fv = glProgramUniformMatrix3x2fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix2x4_fv = glProgramUniformMatrix2x4fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix4x2_fv = glProgramUniformMatrix4x2fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix3x4_fv = glProgramUniformMatrix3x4fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix4x3_fv = glProgramUniformMatrix4x3fv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix2x3_dv = glProgramUniformMatrix2x3dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix3x2_dv = glProgramUniformMatrix3x2dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix2x4_dv = glProgramUniformMatrix2x4dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix4x2_dv = glProgramUniformMatrix4x2dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix3x4_dv = glProgramUniformMatrix3x4dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun program_uniform_matrix4x3_dv = glProgramUniformMatrix4x3dv(
    program : UInt,
    location : Int,
    count : SizeI,
    transpose : Boolean,
  ...
  fun get_vertex_attrib_l_dv = glGetVertexAttribLdv(
    index : UInt,
    pname : VertexAttribEnum,
    params : ::Pointer(Double)
  ) : ::Void

  fun viewport_array_v = glViewportArrayv(
    first : UInt,
    count : SizeI,
    v : ::Pointer(Float)
  ) : ::Void
  ...
  fun depth_range_array_v = glDepthRangeArrayv(
    first : UInt,
    count : SizeI,
    v : ::Pointer(Double)
  ) : ::Void
  ...
  fun get_active_atomic_counter_buffer_iv = glGetActiveAtomicCounterBufferiv(
    program : UInt,
    bufferIndex : UInt,
  ...
  fun get_transform_feedback_i_v = glGetTransformFeedbacki_v(
    xfb : UInt,
    pname : TransformFeedbackPName,
    index : UInt,
    param : ::Pointer(Int)
  ...
  fun clear_named_framebuffer_fi = glClearNamedFramebufferfi(
    framebuffer : UInt,
    buffer : Buffer,
    drawbuffer : Int,
    depth : Float,
  ...
  fun get_query_buffer_object_ui64v = glGetQueryBufferObjectui64v(
    id : UInt,
    buffer : UInt,
    pname : QueryObjectParameterName,
    offset : IntPtr
  ...
  fun getn_pixel_map_fv = glGetnPixelMapfv(
    map : PixelMap,
    bufSize : SizeI,
    values : ::Pointer(Float)
  ) : ::Void

  fun getn_pixel_map_uiv = glGetnPixelMapuiv(
    map : PixelMap,
    bufSize : SizeI,
    values : ::Pointer(UInt)
  ) : ::Void

  fun getn_pixel_map_usv = glGetnPixelMapusv(
    map : PixelMap,
    bufSize : SizeI,
    values : ::Pointer(UShort)
  ) : ::Void

  fun getn_polygon_stipple = glGetnPolygonStipple(
    bufSize : SizeI,
    pattern : ::Pointer(UByte)
  ) : ::Void

  fun getn_color_table = glGetnColorTable(
    target : Enum,
    format : PixelFormat,
    type : PixelType,
    bufSize : SizeI,
  ...
  fun getn_convolution_filter = glGetnConvolutionFilter(
    target : Enum,
    format : PixelFormat,
    type : PixelType,
    bufSize : SizeI,
  ...
  fun getn_separable_filter = glGetnSeparableFilter(
    target : Enum,
    format : PixelFormat,
    type : PixelType,
    rowBufSize : SizeI,
  ...
  fun getn_histogram = glGetnHistogram(
    target : Enum,
    reset : Boolean,
    format : PixelFormat,
    type : PixelType,
  ...
  fun specialize_shader = glSpecializeShader(
    shader : UInt,
  ...
  fun multi_draw_arrays_indirect_count = glMultiDrawArraysIndirectCount(
    mode : PrimitiveType,
    indirect : ::Pointer(Void),
    drawcount : IntPtr,
    maxdrawcount : SizeI,
  ...
  fun polygon_offset_clamp = glPolygonOffsetClamp(
    factor : Float,
    units : Float,
    clamp : Float
  ) : ::Void
