...
module OpenGL
  ...
  struct Loader
    ...
    def clear_buffer_data : ::Proc
      get_proc(870, Translations.clear_buffer_data, Procs.clear_buffer_data)
    end
    ...
    def clear_buffer_sub_data : ::Proc
      get_proc(871, Translations.clear_buffer_sub_data, Procs.clear_buffer_sub_data)
    end
    ...
    def dispatch_compute : ::Proc
      get_proc(872, Translations.dispatch_compute, Procs.dispatch_compute)
    end
    ...
    def dispatch_compute_indirect : ::Proc
      get_proc(873, Translations.dispatch_compute_indirect, Procs.dispatch_compute_indirect)
    end
    ...
    def copy_image_sub_data : ::Proc
      get_proc(874, Translations.copy_image_sub_data, Procs.copy_image_sub_data)
    end
    ...
    def framebuffer_parameter_i : ::Proc
      get_proc(875, Translations.framebuffer_parameter_i, Procs.framebuffer_parameter_i)
    end
    ...
    def get_framebuffer_parameter_iv : ::Proc
      get_proc(876, Translations.get_framebuffer_parameter_iv, Procs.get_framebuffer_parameter_iv)
    end
    ...
    def get_internalformat_i64v : ::Proc
      get_proc(877, Translations.get_internalformat_i64v, Procs.get_internalformat_i64v)
    end
    ...
    def invalidate_tex_sub_image : ::Proc
      get_proc(878, Translations.invalidate_tex_sub_image, Procs.invalidate_tex_sub_image)
    end
    ...
    def invalidate_tex_image : ::Proc
      get_proc(879, Translations.invalidate_tex_image, Procs.invalidate_tex_image)
    end
    ...
    def invalidate_buffer_sub_data : ::Proc
      get_proc(880, Translations.invalidate_buffer_sub_data, Procs.invalidate_buffer_sub_data)
    end
    ...
    def invalidate_buffer_data : ::Proc
      get_proc(881, Translations.invalidate_buffer_data, Procs.invalidate_buffer_data)
    end
    ...
    def invalidate_framebuffer : ::Proc
      get_proc(882, Translations.invalidate_framebuffer, Procs.invalidate_framebuffer)
    end
    ...
    def invalidate_sub_framebuffer : ::Proc
      get_proc(883, Translations.invalidate_sub_framebuffer, Procs.invalidate_sub_framebuffer)
    end
    ...
    def multi_draw_arrays_indirect : ::Proc
      get_proc(884, Translations.multi_draw_arrays_indirect, Procs.multi_draw_arrays_indirect)
    end
    ...
    def multi_draw_elements_indirect : ::Proc
      get_proc(885, Translations.multi_draw_elements_indirect, Procs.multi_draw_elements_indirect)
    end
    ...
    def get_program_interface_iv : ::Proc
      get_proc(886, Translations.get_program_interface_iv, Procs.get_program_interface_iv)
    end
    ...
    def get_program_resource_index : ::Proc
      get_proc(887, Translations.get_program_resource_index, Procs.get_program_resource_index)
    end
    ...
    def get_program_resource_name : ::Proc
      get_proc(888, Translations.get_program_resource_name, Procs.get_program_resource_name)
    end
    ...
    def get_program_resource_iv : ::Proc
      get_proc(889, Translations.get_program_resource_iv, Procs.get_program_resource_iv)
    end
    ...
    def get_program_resource_location : ::Proc
      get_proc(890, Translations.get_program_resource_location, Procs.get_program_resource_location)
    end
    ...
    def get_program_resource_location_index : ::Proc
      get_proc(891, Translations.get_program_resource_location_index, Procs.get_program_resource_location_index)
    end
    ...
    def shader_storage_block_binding : ::Proc
      get_proc(892, Translations.shader_storage_block_binding, Procs.shader_storage_block_binding)
    end
    ...
    def tex_buffer_range : ::Proc
      get_proc(893, Translations.tex_buffer_range, Procs.tex_buffer_range)
    end
    ...
    def tex_storage_2d_multisample : ::Proc
      get_proc(894, Translations.tex_storage_2d_multisample, Procs.tex_storage_2d_multisample)
    end
    ...
    def tex_storage_3d_multisample : ::Proc
      get_proc(895, Translations.tex_storage_3d_multisample, Procs.tex_storage_3d_multisample)
    end
    ...
    def texture_view : ::Proc
      get_proc(896, Translations.texture_view, Procs.texture_view)
    end
    ...
    def bind_vertex_buffer : ::Proc
      get_proc(897, Translations.bind_vertex_buffer, Procs.bind_vertex_buffer)
    end
    ...
    def vertex_attrib_format : ::Proc
      get_proc(898, Translations.vertex_attrib_format, Procs.vertex_attrib_format)
    end
    ...
    def vertex_attrib_i_format : ::Proc
      get_proc(899, Translations.vertex_attrib_i_format, Procs.vertex_attrib_i_format)
    end
    ...
    def vertex_attrib_l_format : ::Proc
      get_proc(900, Translations.vertex_attrib_l_format, Procs.vertex_attrib_l_format)
    end
    ...
    def vertex_attrib_binding : ::Proc
      get_proc(901, Translations.vertex_attrib_binding, Procs.vertex_attrib_binding)
    end
    ...
    def vertex_binding_divisor : ::Proc
      get_proc(902, Translations.vertex_binding_divisor, Procs.vertex_binding_divisor)
    end
    ...
    def debug_message_control : ::Proc
      get_proc(903, Translations.debug_message_control, Procs.debug_message_control)
    end
    ...
    def debug_message_insert : ::Proc
      get_proc(904, Translations.debug_message_insert, Procs.debug_message_insert)
    end
    ...
    def debug_message_callback : ::Proc
      get_proc(905, Translations.debug_message_callback, Procs.debug_message_callback)
    end
    ...
    def get_debug_message_log : ::Proc
      get_proc(906, Translations.get_debug_message_log, Procs.get_debug_message_log)
    end
    ...
    def push_debug_group : ::Proc
      get_proc(907, Translations.push_debug_group, Procs.push_debug_group)
    end
    ...
    def pop_debug_group : ::Proc
      get_proc(908, Translations.pop_debug_group, Procs.pop_debug_group)
    end
    ...
    def object_label : ::Proc
      get_proc(909, Translations.object_label, Procs.object_label)
    end
    ...
    def get_object_label : ::Proc
      get_proc(910, Translations.get_object_label, Procs.get_object_label)
    end
    ...
    def object_ptr_label : ::Proc
      get_proc(911, Translations.object_ptr_label, Procs.object_ptr_label)
    end
    ...
    def get_object_ptr_label : ::Proc
      get_proc(912, Translations.get_object_ptr_label, Procs.get_object_ptr_label)
    end
    ...
    def buffer_storage : ::Proc
      get_proc(913, Translations.buffer_storage, Procs.buffer_storage)
    end
    ...
    def clear_tex_image : ::Proc
      get_proc(914, Translations.clear_tex_image, Procs.clear_tex_image)
    end
    ...
    def clear_tex_sub_image : ::Proc
      get_proc(915, Translations.clear_tex_sub_image, Procs.clear_tex_sub_image)
    end
    ...
    def bind_buffers_base : ::Proc
      get_proc(916, Translations.bind_buffers_base, Procs.bind_buffers_base)
    end
    ...
    def bind_buffers_range : ::Proc
      get_proc(917, Translations.bind_buffers_range, Procs.bind_buffers_range)
    end
    ...
    def bind_textures : ::Proc
      get_proc(918, Translations.bind_textures, Procs.bind_textures)
    end
    ...
    def bind_samplers : ::Proc
      get_proc(919, Translations.bind_samplers, Procs.bind_samplers)
    end
    ...
    def bind_image_textures : ::Proc
      get_proc(920, Translations.bind_image_textures, Procs.bind_image_textures)
    end
    ...
    def bind_vertex_buffers : ::Proc
      get_proc(921, Translations.bind_vertex_buffers, Procs.bind_vertex_buffers)
    end
    ...
    def clip_control : ::Proc
      get_proc(922, Translations.clip_control, Procs.clip_control)
    end
    ...
    def create_transform_feedbacks : ::Proc
      get_proc(923, Translations.create_transform_feedbacks, Procs.create_transform_feedbacks)
    end
    ...
    def transform_feedback_buffer_base : ::Proc
      get_proc(924, Translations.transform_feedback_buffer_base, Procs.transform_feedback_buffer_base)
    end
    ...
    def transform_feedback_buffer_range : ::Proc
      get_proc(925, Translations.transform_feedback_buffer_range, Procs.transform_feedback_buffer_range)
    end
    ...
    def get_transform_feedback_iv : ::Proc
      get_proc(926, Translations.get_transform_feedback_iv, Procs.get_transform_feedback_iv)
    end
    ...
    def get_transform_feedback_i_v : ::Proc
      get_proc(927, Translations.get_transform_feedback_i_v, Procs.get_transform_feedback_i_v)
    end
    ...
    def get_transform_feedback_i64_v : ::Proc
      get_proc(928, Translations.get_transform_feedback_i64_v, Procs.get_transform_feedback_i64_v)
    end
    ...
    def create_buffers : ::Proc
      get_proc(929, Translations.create_buffers, Procs.create_buffers)
    end
    ...
    def named_buffer_storage : ::Proc
      get_proc(930, Translations.named_buffer_storage, Procs.named_buffer_storage)
    end
    ...
    def named_buffer_data : ::Proc
      get_proc(931, Translations.named_buffer_data, Procs.named_buffer_data)
    end
    ...
    def named_buffer_sub_data : ::Proc
      get_proc(932, Translations.named_buffer_sub_data, Procs.named_buffer_sub_data)
    end
    ...
    def copy_named_buffer_sub_data : ::Proc
      get_proc(933, Translations.copy_named_buffer_sub_data, Procs.copy_named_buffer_sub_data)
    end
    ...
    def clear_named_buffer_data : ::Proc
      get_proc(934, Translations.clear_named_buffer_data, Procs.clear_named_buffer_data)
    end
    ...
    def clear_named_buffer_sub_data : ::Proc
      get_proc(935, Translations.clear_named_buffer_sub_data, Procs.clear_named_buffer_sub_data)
    end
    ...
    def map_named_buffer : ::Proc
      get_proc(936, Translations.map_named_buffer, Procs.map_named_buffer)
    end
    ...
    def map_named_buffer_range : ::Proc
      get_proc(937, Translations.map_named_buffer_range, Procs.map_named_buffer_range)
    end
    ...
    def unmap_named_buffer : ::Proc
      get_proc(938, Translations.unmap_named_buffer, Procs.unmap_named_buffer)
    end
    ...
    def flush_mapped_named_buffer_range : ::Proc
      get_proc(939, Translations.flush_mapped_named_buffer_range, Procs.flush_mapped_named_buffer_range)
    end
    ...
    def get_named_buffer_parameter_iv : ::Proc
      get_proc(940, Translations.get_named_buffer_parameter_iv, Procs.get_named_buffer_parameter_iv)
    end
    ...
    def get_named_buffer_parameter_i64v : ::Proc
      get_proc(941, Translations.get_named_buffer_parameter_i64v, Procs.get_named_buffer_parameter_i64v)
    end
    ...
    def get_named_buffer_pointer_v : ::Proc
      get_proc(942, Translations.get_named_buffer_pointer_v, Procs.get_named_buffer_pointer_v)
    end
    ...
    def get_named_buffer_sub_data : ::Proc
      get_proc(943, Translations.get_named_buffer_sub_data, Procs.get_named_buffer_sub_data)
    end
    ...
    def create_framebuffers : ::Proc
      get_proc(944, Translations.create_framebuffers, Procs.create_framebuffers)
    end
    ...
    def named_framebuffer_renderbuffer : ::Proc
      get_proc(945, Translations.named_framebuffer_renderbuffer, Procs.named_framebuffer_renderbuffer)
    end
    ...
    def named_framebuffer_parameter_i : ::Proc
      get_proc(946, Translations.named_framebuffer_parameter_i, Procs.named_framebuffer_parameter_i)
    end
    ...
    def named_framebuffer_texture : ::Proc
      get_proc(947, Translations.named_framebuffer_texture, Procs.named_framebuffer_texture)
    end
    ...
    def named_framebuffer_texture_layer : ::Proc
      get_proc(948, Translations.named_framebuffer_texture_layer, Procs.named_framebuffer_texture_layer)
    end
    ...
    def named_framebuffer_draw_buffer : ::Proc
      get_proc(949, Translations.named_framebuffer_draw_buffer, Procs.named_framebuffer_draw_buffer)
    end
    ...
    def named_framebuffer_draw_buffers : ::Proc
      get_proc(950, Translations.named_framebuffer_draw_buffers, Procs.named_framebuffer_draw_buffers)
    end
    ...
    def named_framebuffer_read_buffer : ::Proc
      get_proc(951, Translations.named_framebuffer_read_buffer, Procs.named_framebuffer_read_buffer)
    end
    ...
    def invalidate_named_framebuffer_data : ::Proc
      get_proc(952, Translations.invalidate_named_framebuffer_data, Procs.invalidate_named_framebuffer_data)
    end
    ...
    def invalidate_named_framebuffer_sub_data : ::Proc
      get_proc(953, Translations.invalidate_named_framebuffer_sub_data, Procs.invalidate_named_framebuffer_sub_data)
    end
    ...
    def clear_named_framebuffer_iv : ::Proc
      get_proc(954, Translations.clear_named_framebuffer_iv, Procs.clear_named_framebuffer_iv)
    end
    ...
    def clear_named_framebuffer_uiv : ::Proc
      get_proc(955, Translations.clear_named_framebuffer_uiv, Procs.clear_named_framebuffer_uiv)
    end
    ...
    def clear_named_framebuffer_fv : ::Proc
      get_proc(956, Translations.clear_named_framebuffer_fv, Procs.clear_named_framebuffer_fv)
    end
    ...
    def clear_named_framebuffer_fi : ::Proc
      get_proc(957, Translations.clear_named_framebuffer_fi, Procs.clear_named_framebuffer_fi)
    end
    ...
    def blit_named_framebuffer : ::Proc
      get_proc(958, Translations.blit_named_framebuffer, Procs.blit_named_framebuffer)
    end
    ...
    def check_named_framebuffer_status : ::Proc
      get_proc(959, Translations.check_named_framebuffer_status, Procs.check_named_framebuffer_status)
    end
    ...
    def get_named_framebuffer_parameter_iv : ::Proc
      get_proc(960, Translations.get_named_framebuffer_parameter_iv, Procs.get_named_framebuffer_parameter_iv)
    end
    ...
    def get_named_framebuffer_attachment_parameter_iv : ::Proc
      get_proc(961, Translations.get_named_framebuffer_attachment_parameter_iv, Procs.get_named_framebuffer_attachment_parameter_iv)
    end
    ...
    def create_renderbuffers : ::Proc
      get_proc(962, Translations.create_renderbuffers, Procs.create_renderbuffers)
    end
    ...
    def named_renderbuffer_storage : ::Proc
      get_proc(963, Translations.named_renderbuffer_storage, Procs.named_renderbuffer_storage)
    end
    ...
    def named_renderbuffer_storage_multisample : ::Proc
      get_proc(964, Translations.named_renderbuffer_storage_multisample, Procs.named_renderbuffer_storage_multisample)
    end
    ...
    def get_named_renderbuffer_parameter_iv : ::Proc
      get_proc(965, Translations.get_named_renderbuffer_parameter_iv, Procs.get_named_renderbuffer_parameter_iv)
    end
    ...
    def create_textures : ::Proc
      get_proc(966, Translations.create_textures, Procs.create_textures)
    end
    ...
    def texture_buffer : ::Proc
      get_proc(967, Translations.texture_buffer, Procs.texture_buffer)
    end
    ...
    def texture_buffer_range : ::Proc
      get_proc(968, Translations.texture_buffer_range, Procs.texture_buffer_range)
    end
    ...
    def texture_storage_1d : ::Proc
      get_proc(969, Translations.texture_storage_1d, Procs.texture_storage_1d)
    end
    ...
    def texture_storage_2d : ::Proc
      get_proc(970, Translations.texture_storage_2d, Procs.texture_storage_2d)
    end
    ...
    def texture_storage_3d : ::Proc
      get_proc(971, Translations.texture_storage_3d, Procs.texture_storage_3d)
    end
    ...
    def texture_storage_2d_multisample : ::Proc
      get_proc(972, Translations.texture_storage_2d_multisample, Procs.texture_storage_2d_multisample)
    end
    ...
    def texture_storage_3d_multisample : ::Proc
      get_proc(973, Translations.texture_storage_3d_multisample, Procs.texture_storage_3d_multisample)
    end
    ...
    def texture_sub_image_1d : ::Proc
      get_proc(974, Translations.texture_sub_image_1d, Procs.texture_sub_image_1d)
    end
    ...
    def texture_sub_image_2d : ::Proc
      get_proc(975, Translations.texture_sub_image_2d, Procs.texture_sub_image_2d)
    end
    ...
    def texture_sub_image_3d : ::Proc
      get_proc(976, Translations.texture_sub_image_3d, Procs.texture_sub_image_3d)
    end
    ...
    def compressed_texture_sub_image_1d : ::Proc
      get_proc(977, Translations.compressed_texture_sub_image_1d, Procs.compressed_texture_sub_image_1d)
    end
    ...
    def compressed_texture_sub_image_2d : ::Proc
      get_proc(978, Translations.compressed_texture_sub_image_2d, Procs.compressed_texture_sub_image_2d)
    end
    ...
    def compressed_texture_sub_image_3d : ::Proc
      get_proc(979, Translations.compressed_texture_sub_image_3d, Procs.compressed_texture_sub_image_3d)
    end
    ...
    def copy_texture_sub_image_1d : ::Proc
      get_proc(980, Translations.copy_texture_sub_image_1d, Procs.copy_texture_sub_image_1d)
    end
    ...
    def copy_texture_sub_image_2d : ::Proc
      get_proc(981, Translations.copy_texture_sub_image_2d, Procs.copy_texture_sub_image_2d)
    end
    ...
    def copy_texture_sub_image_3d : ::Proc
      get_proc(982, Translations.copy_texture_sub_image_3d, Procs.copy_texture_sub_image_3d)
    end
    ...
    def texture_parameter_f : ::Proc
      get_proc(983, Translations.texture_parameter_f, Procs.texture_parameter_f)
    end
    ...
    def texture_parameter_fv : ::Proc
      get_proc(984, Translations.texture_parameter_fv, Procs.texture_parameter_fv)
    end
    ...
    def texture_parameter_i : ::Proc
      get_proc(985, Translations.texture_parameter_i, Procs.texture_parameter_i)
    end
    ...
    def texture_parameter_i_iv : ::Proc
      get_proc(986, Translations.texture_parameter_i_iv, Procs.texture_parameter_i_iv)
    end
    ...
    def texture_parameter_i_uiv : ::Proc
      get_proc(987, Translations.texture_parameter_i_uiv, Procs.texture_parameter_i_uiv)
    end
    ...
    def texture_parameter_iv : ::Proc
      get_proc(988, Translations.texture_parameter_iv, Procs.texture_parameter_iv)
    end
    ...
    def generate_texture_mipmap : ::Proc
      get_proc(989, Translations.generate_texture_mipmap, Procs.generate_texture_mipmap)
    end
    ...
    def bind_texture_unit : ::Proc
      get_proc(990, Translations.bind_texture_unit, Procs.bind_texture_unit)
    end
    ...
    def get_texture_image : ::Proc
      get_proc(991, Translations.get_texture_image, Procs.get_texture_image)
    end
    ...
    def get_compressed_texture_image : ::Proc
      get_proc(992, Translations.get_compressed_texture_image, Procs.get_compressed_texture_image)
    end
    ...
    def get_texture_level_parameter_fv : ::Proc
      get_proc(993, Translations.get_texture_level_parameter_fv, Procs.get_texture_level_parameter_fv)
    end
    ...
    def get_texture_level_parameter_iv : ::Proc
      get_proc(994, Translations.get_texture_level_parameter_iv, Procs.get_texture_level_parameter_iv)
    end
    ...
    def get_texture_parameter_fv : ::Proc
      get_proc(995, Translations.get_texture_parameter_fv, Procs.get_texture_parameter_fv)
    end
    ...
    def get_texture_parameter_i_iv : ::Proc
      get_proc(996, Translations.get_texture_parameter_i_iv, Procs.get_texture_parameter_i_iv)
    end
    ...
    def get_texture_parameter_i_uiv : ::Proc
      get_proc(997, Translations.get_texture_parameter_i_uiv, Procs.get_texture_parameter_i_uiv)
    end
    ...
    def get_texture_parameter_iv : ::Proc
      get_proc(998, Translations.get_texture_parameter_iv, Procs.get_texture_parameter_iv)
    end
    ...
    def create_vertex_arrays : ::Proc
      get_proc(999, Translations.create_vertex_arrays, Procs.create_vertex_arrays)
    end
    ...
    def disable_vertex_array_attrib : ::Proc
      get_proc(1000, Translations.disable_vertex_array_attrib, Procs.disable_vertex_array_attrib)
    end
    ...
    def enable_vertex_array_attrib : ::Proc
      get_proc(1001, Translations.enable_vertex_array_attrib, Procs.enable_vertex_array_attrib)
    end
    ...
    def vertex_array_element_buffer : ::Proc
      get_proc(1002, Translations.vertex_array_element_buffer, Procs.vertex_array_element_buffer)
    end
    ...
    def vertex_array_vertex_buffer : ::Proc
      get_proc(1003, Translations.vertex_array_vertex_buffer, Procs.vertex_array_vertex_buffer)
    end
    ...
    def vertex_array_vertex_buffers : ::Proc
      get_proc(1004, Translations.vertex_array_vertex_buffers, Procs.vertex_array_vertex_buffers)
    end
    ...
    def vertex_array_attrib_binding : ::Proc
      get_proc(1005, Translations.vertex_array_attrib_binding, Procs.vertex_array_attrib_binding)
    end
    ...
    def vertex_array_attrib_format : ::Proc
      get_proc(1006, Translations.vertex_array_attrib_format, Procs.vertex_array_attrib_format)
    end
    ...
    def vertex_array_attrib_i_format : ::Proc
      get_proc(1007, Translations.vertex_array_attrib_i_format, Procs.vertex_array_attrib_i_format)
    end
    ...
    def vertex_array_attrib_l_format : ::Proc
      get_proc(1008, Translations.vertex_array_attrib_l_format, Procs.vertex_array_attrib_l_format)
    end
    ...
    def vertex_array_binding_divisor : ::Proc
      get_proc(1009, Translations.vertex_array_binding_divisor, Procs.vertex_array_binding_divisor)
    end
    ...
    def get_vertex_array_iv : ::Proc
      get_proc(1010, Translations.get_vertex_array_iv, Procs.get_vertex_array_iv)
    end
    ...
    def get_vertex_array_indexed_iv : ::Proc
      get_proc(1011, Translations.get_vertex_array_indexed_iv, Procs.get_vertex_array_indexed_iv)
    end
    ...
    def get_vertex_array_indexed_64iv : ::Proc
      get_proc(1012, Translations.get_vertex_array_indexed_64iv, Procs.get_vertex_array_indexed_64iv)
    end
    ...
    def create_samplers : ::Proc
      get_proc(1013, Translations.create_samplers, Procs.create_samplers)
    end
    ...
    def create_program_pipelines : ::Proc
      get_proc(1014, Translations.create_program_pipelines, Procs.create_program_pipelines)
    end
    ...
    def create_queries : ::Proc
      get_proc(1015, Translations.create_queries, Procs.create_queries)
    end
    ...
    def get_query_buffer_object_i64v : ::Proc
      get_proc(1016, Translations.get_query_buffer_object_i64v, Procs.get_query_buffer_object_i64v)
    end
    ...
    def get_query_buffer_object_iv : ::Proc
      get_proc(1017, Translations.get_query_buffer_object_iv, Procs.get_query_buffer_object_iv)
    end
    ...
    def get_query_buffer_object_ui64v : ::Proc
      get_proc(1018, Translations.get_query_buffer_object_ui64v, Procs.get_query_buffer_object_ui64v)
    end
    ...
    def get_query_buffer_object_uiv : ::Proc
      get_proc(1019, Translations.get_query_buffer_object_uiv, Procs.get_query_buffer_object_uiv)
    end
    ...
    def memory_barrier_by_region : ::Proc
      get_proc(1020, Translations.memory_barrier_by_region, Procs.memory_barrier_by_region)
    end
    ...
    def get_texture_sub_image : ::Proc
      get_proc(1021, Translations.get_texture_sub_image, Procs.get_texture_sub_image)
    end
    ...
    def get_compressed_texture_sub_image : ::Proc
      get_proc(1022, Translations.get_compressed_texture_sub_image, Procs.get_compressed_texture_sub_image)
    end
    ...
    def get_graphics_reset_status : ::Proc
      get_proc(1023, Translations.get_graphics_reset_status, Procs.get_graphics_reset_status)
    end
    ...
    def getn_compressed_tex_image : ::Proc
      get_proc(1024, Translations.getn_compressed_tex_image, Procs.getn_compressed_tex_image)
    end
    ...
    def getn_tex_image : ::Proc
      get_proc(1025, Translations.getn_tex_image, Procs.getn_tex_image)
    end
    ...
    def getn_uniform_dv : ::Proc
      get_proc(1026, Translations.getn_uniform_dv, Procs.getn_uniform_dv)
    end
    ...
    def getn_uniform_fv : ::Proc
      get_proc(1027, Translations.getn_uniform_fv, Procs.getn_uniform_fv)
    end
    ...
    def getn_uniform_iv : ::Proc
      get_proc(1028, Translations.getn_uniform_iv, Procs.getn_uniform_iv)
    end
    ...
    def getn_uniform_uiv : ::Proc
      get_proc(1029, Translations.getn_uniform_uiv, Procs.getn_uniform_uiv)
    end
    ...
    def readn_pixels : ::Proc
      get_proc(1030, Translations.readn_pixels, Procs.readn_pixels)
    end
    ...
    # Retrieves a `Proc` for the OpenGL function *glGetnMapdv*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_map_dv : ::Proc
      get_proc(1031, Translations.getn_map_dv, Procs.getn_map_dv)
    end

    # Checks if the OpenGL function *glGetnMapdv* is loaded.
    def getn_map_dv?
      !!@addresses[1031]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnMapfv*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_map_fv : ::Proc
      get_proc(1032, Translations.getn_map_fv, Procs.getn_map_fv)
    end

    # Checks if the OpenGL function *glGetnMapfv* is loaded.
    def getn_map_fv?
      !!@addresses[1032]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnMapiv*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_map_iv : ::Proc
      get_proc(1033, Translations.getn_map_iv, Procs.getn_map_iv)
    end

    # Checks if the OpenGL function *glGetnMapiv* is loaded.
    def getn_map_iv?
      !!@addresses[1033]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnPixelMapfv*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_pixel_map_fv : ::Proc
      get_proc(1034, Translations.getn_pixel_map_fv, Procs.getn_pixel_map_fv)
    end

    # Checks if the OpenGL function *glGetnPixelMapfv* is loaded.
    def getn_pixel_map_fv?
      !!@addresses[1034]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnPixelMapuiv*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_pixel_map_uiv : ::Proc
      get_proc(1035, Translations.getn_pixel_map_uiv, Procs.getn_pixel_map_uiv)
    end

    # Checks if the OpenGL function *glGetnPixelMapuiv* is loaded.
    def getn_pixel_map_uiv?
      !!@addresses[1035]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnPixelMapusv*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_pixel_map_usv : ::Proc
      get_proc(1036, Translations.getn_pixel_map_usv, Procs.getn_pixel_map_usv)
    end

    # Checks if the OpenGL function *glGetnPixelMapusv* is loaded.
    def getn_pixel_map_usv?
      !!@addresses[1036]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnPolygonStipple*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_polygon_stipple : ::Proc
      get_proc(1037, Translations.getn_polygon_stipple, Procs.getn_polygon_stipple)
    end

    # Checks if the OpenGL function *glGetnPolygonStipple* is loaded.
    def getn_polygon_stipple?
      !!@addresses[1037]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnColorTable*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_color_table : ::Proc
      get_proc(1038, Translations.getn_color_table, Procs.getn_color_table)
    end

    # Checks if the OpenGL function *glGetnColorTable* is loaded.
    def getn_color_table?
      !!@addresses[1038]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnConvolutionFilter*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_convolution_filter : ::Proc
      get_proc(1039, Translations.getn_convolution_filter, Procs.getn_convolution_filter)
    end

    # Checks if the OpenGL function *glGetnConvolutionFilter* is loaded.
    def getn_convolution_filter?
      !!@addresses[1039]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnSeparableFilter*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_separable_filter : ::Proc
      get_proc(1040, Translations.getn_separable_filter, Procs.getn_separable_filter)
    end

    # Checks if the OpenGL function *glGetnSeparableFilter* is loaded.
    def getn_separable_filter?
      !!@addresses[1040]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnHistogram*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_histogram : ::Proc
      get_proc(1041, Translations.getn_histogram, Procs.getn_histogram)
    end

    # Checks if the OpenGL function *glGetnHistogram* is loaded.
    def getn_histogram?
      !!@addresses[1041]
    end

    # Retrieves a `Proc` for the OpenGL function *glGetnMinmax*.
    # Attempts to retrieve (load) the address of the function if it hasn't already been retrieved.
    # Raises `FunctionUnavailableError` if the function isn't found.
    def getn_minmax : ::Proc
      get_proc(1042, Translations.getn_minmax, Procs.getn_minmax)
    end

    # Checks if the OpenGL function *glGetnMinmax* is loaded.
    def getn_minmax?
      !!@addresses[1042]
    end
    ...
    def texture_barrier : ::Proc
      get_proc(1043, Translations.texture_barrier, Procs.texture_barrier)
    end
    ...
    def specialize_shader : ::Proc
      get_proc(1044, Translations.specialize_shader, Procs.specialize_shader)
    end
    ...
    def multi_draw_arrays_indirect_count : ::Proc
      get_proc(1045, Translations.multi_draw_arrays_indirect_count, Procs.multi_draw_arrays_indirect_count)
    end
    ...
    def multi_draw_elements_indirect_count : ::Proc
      get_proc(1046, Translations.multi_draw_elements_indirect_count, Procs.multi_draw_elements_indirect_count)
    end
    ...
    def polygon_offset_clamp : ::Proc
      get_proc(1047, Translations.polygon_offset_clamp, Procs.polygon_offset_clamp)
    end
