...
module OpenGL
  ...
  class Loader
    ...
    def initialize
      ...
      @addr_getn_map_dv = ::Pointer(::Void).null
      @addr_getn_map_fv = ::Pointer(::Void).null
      @addr_getn_map_iv = ::Pointer(::Void).null
      @addr_getn_pixel_map_fv = ::Pointer(::Void).null
      @addr_getn_pixel_map_uiv = ::Pointer(::Void).null
      @addr_getn_pixel_map_usv = ::Pointer(::Void).null
      @addr_getn_polygon_stipple = ::Pointer(::Void).null
      @addr_getn_color_table = ::Pointer(::Void).null
      @addr_getn_convolution_filter = ::Pointer(::Void).null
      @addr_getn_separable_filter = ::Pointer(::Void).null
      @addr_getn_histogram = ::Pointer(::Void).null
      @addr_getn_minmax = ::Pointer(::Void).null
    ...
    def load_all(& : String -> Void*)
      ...
      @addr_getn_map_dv = yield "glGetnMapdv"
      @addr_getn_map_fv = yield "glGetnMapfv"
      @addr_getn_map_iv = yield "glGetnMapiv"
      @addr_getn_pixel_map_fv = yield "glGetnPixelMapfv"
      @addr_getn_pixel_map_uiv = yield "glGetnPixelMapuiv"
      @addr_getn_pixel_map_usv = yield "glGetnPixelMapusv"
      @addr_getn_polygon_stipple = yield "glGetnPolygonStipple"
      @addr_getn_color_table = yield "glGetnColorTable"
      @addr_getn_convolution_filter = yield "glGetnConvolutionFilter"
      @addr_getn_separable_filter = yield "glGetnSeparableFilter"
      @addr_getn_histogram = yield "glGetnHistogram"
      @addr_getn_minmax = yield "glGetnMinmax"
    ...
    def getn_map_dv!(*args)
      addr = @addr_getn_map_dv
      proc = Procs.getn_map_dv(addr)
      proc.call(*args)
    end
    ...
    def getn_map_dv? : Bool
      !@addr_getn_map_dv.null?
    end

    # Invokes glGetnMapfv.
    # This method is unsafe and will crash the program if the function isn't loaded.
    def getn_map_fv!(*args)
      addr = @addr_getn_map_fv
      proc = Procs.getn_map_fv(addr)
      proc.call(*args)
    end
    ...
    def getn_map_fv? : Bool
      !@addr_getn_map_fv.null?
    end

    # Invokes glGetnMapiv.
    # This method is unsafe and will crash the program if the function isn't loaded.
    def getn_map_iv!(*args)
      addr = @addr_getn_map_iv
      proc = Procs.getn_map_iv(addr)
      proc.call(*args)
    end
    ...
    def getn_map_iv? : Bool
      !@addr_getn_map_iv.null?
    end

    # Invokes glGetnPixelMapfv.
    # This method is unsafe and will crash the program if the function isn't loaded.
    def getn_pixel_map_fv!(*args)
      addr = @addr_getn_pixel_map_fv
      proc = Procs.getn_pixel_map_fv(addr)
      proc.call(*args)
    end
    ...
    def getn_histogram? : Bool
      !@addr_getn_histogram.null?
    end

    # Invokes glGetnMinmax.
    # This method is unsafe and will crash the program if the function isn't loaded.
    def getn_minmax!(*args)
      addr = @addr_getn_minmax
      proc = Procs.getn_minmax(addr)
      proc.call(*args)
    end
