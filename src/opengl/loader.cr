...
module OpenGL
  ...
  class Loader
    ...
    def initialize
      ...
      @addr_blend_barrier = ::Pointer(::Void).null
      ...
      @addr_primitive_bounding_box = ::Pointer(::Void).null
    ...
    def load_all(& : String -> Void*)
      ...
      @addr_blend_barrier = yield "glBlendBarrier"
      ...
      @addr_primitive_bounding_box = yield "glPrimitiveBoundingBox"
    ...
    def blend_barrier!(*args)
      addr = @addr_blend_barrier
      proc = Procs.blend_barrier(addr)
      proc.call(*args)
    end
    ...
    def primitive_bounding_box!(*args)
      addr = @addr_primitive_bounding_box
      proc = Procs.primitive_bounding_box(addr)
      proc.call(*args)
    end
